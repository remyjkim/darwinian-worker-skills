...
7. For missing or out-of-range hook consent:
...
8. For optional card MCP definitions skipped by the write preview:
...
11. Re-run the relevant read-only commands to confirm the repair.
